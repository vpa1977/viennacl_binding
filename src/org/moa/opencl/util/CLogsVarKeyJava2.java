 ...
 *
 */
public class CLogsVarKeyJava2  extends AbstractUtil {
  ...
  private Buffer m_tmp_log;
	...
	public CLogsVarKeyJava2(Context ctx, boolean use_value, String key_type, String value_type)
	{
		...
		if (!m_context.hasProgram("radixsortcl_hack"))
		{
			...
			*/
			...
			StringBuffer code = loadKernel("radixsort2.cl");
	...
	public CLogsVarKeyJava2(Context ctx, boolean use_value)
	{
		m_parameters = new Parameters();
		m_context = ctx;
		int radix = 1 << m_parameters.radixBits;
