...
public class Operations extends AbstractUtil {
	...
	public Operations(Context ctx)
	{
		...
		//m_binary_search_kernel = m_context.getKernel("operations", "binary_search");
	}
    ...
    m_double2uint_kernel.set_arg(3, rows*num_attributes);
	...
	public void binarySearch(Buffer morton_order_keys, Buffer morton_codes, Buffer search_term, int code_length, int length)
	{
